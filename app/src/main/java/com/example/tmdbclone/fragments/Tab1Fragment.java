...
public class Tab1Fragment extends Fragment {
    ...
    public static Tab1Fragment newInstance(MovieDetailed movie) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView = view.findViewById(R.id.detailMovieDescription);
        textView.setText(movie.getOverview());
        TextView date = view.findViewById(R.id.detailReleaseDate);
